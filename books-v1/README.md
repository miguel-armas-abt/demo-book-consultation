...
| variable          | valor                         |
|-------------------|-------------------------------|
| `<APP_IMAGE>`     | `miguelarmasabt/books:v1.0.1` |
| `<APP_CONTAINER>` | `books-v1`                    |
| `<APP_PORTS>`     | `8080:8080`                   |

## ▶️ Local

1. Descargar e instalar [commons-rxjava-parent](https://github.com/miguel-armas-abt/commons-rxjava-parent/README.md)
